      ...
      builder: (context, appState, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: Text(
              l10n?.navMarketplace ?? 'Marketplace',
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TabBar(
                        ...
                        tabs: isFarmer
                            ? [
                                Tab(text: l10n?.marketplaceSubtitle != null && appState.locale.languageCode == 'hi' ? 'मूल्य तुलना' : 'Price Comparison'),
                                Tab(text: appState.locale.languageCode == 'hi' ? 'मेरे ऑर्डर' : 'My Orders'),
                              ]
                            : [
                                Tab(text: l10n?.navMarketplace != null && appState.locale.languageCode == 'hi' ? 'फसलें देखें' : 'Browse Crops'),
                                Tab(text: appState.locale.languageCode == 'hi' ? 'मेरे ऑर्डर' : 'My Orders'),
                              ],
                      ),
                    ),
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: l10n?.searchCrops ?? 'Search crops...',
