            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.volunteer_activism, color: Color(0xFF2E7D32), size: 18),
                      const SizedBox(width: 8),
                      Text(
                        'Direct Farmer Tip (100% via UPI, 0% Deductions)',
                  ...
                  const SizedBox(height: 8),
                  Row(
                    children: [0, 20, 50, 100].map((amt) {
                      final isSelected = _tipAmount == amt;
                      return Padding(
                        padding: const EdgeInsets.only(right: 8),
                        child: ChoiceChip(
                          label: Text(amt == 0 ? 'No Tip' : '+₹$amt'),
                          selected: isSelected,
