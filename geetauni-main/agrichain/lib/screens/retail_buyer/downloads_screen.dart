  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: EnhancedAppBar(
        title: l10n?.contracts ?? 'My Contracts',
        subtitle: l10n?.contracts != null && Localizations.localeOf(context).languageCode == 'hi' ? 'आपके समझौते और दस्तावेज' : 'Your agreements & documents',
        centerTitle: false,
        actions: const [
          Padding(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  l10n?.contractManager ?? 'Contract Manager',
                ...
                Text(
                  _isLoading
                      ? (isHindi ? 'लोड हो रहा है...' : 'Loading contracts...')
                      : '${_contracts.length} ${l10n?.contractsAvailable ?? 'contracts available'}',
                  style: TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        _buildActionButton(
                          ...
                          label: Localizations.localeOf(context).languageCode == 'hi' ? 'देखें' : 'View',
                        ...
                        _buildActionButton(
                          ...
                          label: isDownloading
                              ? (Localizations.localeOf(context).languageCode == 'hi' ? 'सहेज रहे हैं...' : 'Saving...')
                              : (Localizations.localeOf(context).languageCode == 'hi' ? 'सहेजें' : 'Save'),
                          onTap: isDownloading
                              ? null
      ...
      child: Center(
        child: Column(
          children: [
            ...
            Text(
              isHindi ? 'अनुबंध लोड हो रहे हैं...' : 'Loading your contracts...',
      ...
      child: Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              l10n?.noContractsYet ?? 'No contracts yet',
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w600,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.info_outlined, color: AppTheme.primaryGreen, size: 18),
              const SizedBox(width: 8),
              Text(
                l10n?.aboutContracts ?? 'About Contracts',
                style: const TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.w600,
                  color: AppTheme.primaryGreen,
          ...
          _buildInfoItem(
            l10n?.aboutContractPoint1 ?? 'Contracts are generated automatically when you place orders',
          ),
          _buildInfoItem(l10n?.aboutContractPoint2 ?? 'All contracts are securely stored in the cloud'),
          _buildInfoItem(l10n?.aboutContractPoint3 ?? 'Download or view your contracts anytime'),
          _buildInfoItem(l10n?.aboutContractPoint4 ?? 'Contracts serve as legal proof of transaction'),
        ],
      ),
    );
  }
            ...
            SnackBar(
              content: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Expanded(child: Text('Downloaded ${contract.fileName}')),
                ],
              ),
              backgroundColor: AppTheme.primaryGreen,
              behavior: SnackBarBehavior.floating,
