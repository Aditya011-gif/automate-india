...
class SmartContractService {
  ...
  static const String _escrowContractAddress =
  ...
  static Future<Map<String, dynamic>> createPurchaseContract({
    ...
    final contractData = {
      ...
      'legalCompliance': {
        ...
        'paymentAct2007': {'settlementRegulated': true},
      },
    };
  ...
  // Get contract status
  static Future<Map<String, dynamic>> getContractStatus(
    String contractId,
  ) async {
  ...
  static Future<Map<String, dynamic>> getLegalComplianceDetails(
    String contractId,
  ) async {
    await Future.delayed(const Duration(seconds: 1));
    return {
