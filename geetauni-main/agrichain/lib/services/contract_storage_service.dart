  ...
  static Future<String?> uploadContract({
    ...
    try {
      ...
      try {
        ...
        debugPrint('✅ Contract uploaded to Storage: $storagePath');
      } catch (storageError) {
        debugPrint(
          '⚠️ Firebase Storage upload failed (billing?): $storageError',
        );
        // Fallback: save PDF as Base64 in Firestore directly
        final base64Pdf = base64Encode(pdfBytes);
        downloadUrl = 'data:application/pdf;base64,$base64Pdf';
        debugPrint('✅ Contract saved as Base64 in Firestore instead');
      }
